...
\input{tex/08_jatkuva_integraatio.tex}

\chapter{Testitapauksien määrittäminen}
\label{ch:testitapauksien_maarittaminen}
\input{tex/09_testitapauksien_maarittaminen.tex}
