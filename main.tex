...
\chapter{Ohjelmistojen testaus ja testiautomaatio} \label{ch:07_ohjelmistojen_testaus_ja_testiautomaatio}
  \input{tex/07_ohjelmistojen_testaus_ja_testiautomaatio.tex}
...
\chapter{Priorisointi painotetun verkon avulla} \label{ch:09_priorisointi_painotetun_verkon_avulla}
  \input{tex/09_priorisointi_painotetun_verkon_avulla.tex}
\chapter{Tulosten tarkastelu ja arviointi} \label{ch:10_tulosten_tarkastelu_ja_arviointi}
  \input{tex/10_tulosten_tarkastelu_ja_arviointi.tex}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{appendices}
  \chapter{Dijkstran algoritmi pseudokoodina} \label{ch:12_liite_dijkstran_algoritmi}
  \input{./tex/12_liite_dijkstran_algoritmi.tex}
\end{appendices}
\end{document}