...
\chapter{Priorisointi painotetun verkon avulla} \label{ch:10_priorisointi_painotetun_verkon_avulla}
  \input{tex/10_priorisointi_painotetun_verkon_avulla.tex}
\chapter{Tulosten tarkastelu ja arviointi} \label{ch:11_tulosten_tarkastelu_ja_arviointi}
  \input{tex/11_tulosten_tarkastelu_ja_arviointi.tex}
\chapter{Yhteenveto} \label{ch:12_yhteenveto}
  \input{tex/12_yhteenveto.tex}
...
\chapter{Esimerkki testitapauksesta Robot Frameworkillä} \label{ch:13_liite_robot_testitapaus}
  \input{./tex/13_liite_robot_testitapaus.tex}
\chapter{Dijkstran algoritmi pseudokoodina} \label{ch:14_liite_dijkstran_algoritmi}
  \input{./tex/14_liite_dijkstran_algoritmi.tex}
\end{appendices}
\end{document}