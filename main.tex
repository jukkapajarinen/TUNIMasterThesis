...
\documentclass[finnish, authoryear]{tauthesis}
...
\input{tex/06_esitystyyli.tex}

\chapter{Viittaustekniikat}
\label{ch:viittaustekniikat}
\input{tex/07_viittaustekniikat.tex}

% Add chapters similarly.

\chapter{Yhteenveto}
\label{ch:yhteenveto}
\input{tex/08_yhteenveto.tex}
