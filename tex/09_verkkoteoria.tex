...
\section{Painotettu verkko} \label{09_painotettu_verkko}

\begin{itemize}
  \item \(\alpha := V(G), E(G) \rightarrow \mathbb{N}\) Painofunktion yleinen kuvaus.
\end{itemize}

\section{Verkon leikkaaminen} \label{09_verkon_leikkaaminen}

% Teksti tähän

\section{Lyhimmän polun ongelma} \label{09_lyhimman_polun_ongelma}

\begin{itemize}
  \item \(d_G^\alpha(v_1, v_2) = min\{\alpha(P) | P:v_1 \rightarrow v_2 | v_1, v_2 \in V(G)\}\) Lyhimmän polun ongelma.
\end{itemize}

  \subsection{Dijkstran algoritmi} \label{09_djikstran_algoritmi}
