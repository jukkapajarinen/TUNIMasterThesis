...
Design science menetelmää käyttäessä pyritään tutkimaan uusia ratkaisumalleja ratkeisemattomiin ongelmiin tai kehittämään parempia ratkaisumalleja jo aiemmin ratkaistujen ongelmien tilalle.
