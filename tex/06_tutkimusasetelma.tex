...
\section{Tutkimuskysymykset} \label{ch:06_tutkimuskysymykset}
  ...
  Valittua menetelmää käytettäessä pyritään tutkimaan uusia teknologiaa hyödyntäviä ratkaisumalleja ratkaisemattomiin ongelmiin, tai kehittämään parempia ratkaisumalleja jo aiemmin ratkaistujen ongelmien tilalle.
  ...
  Näiden osalta yhteistä on, että niissä on usein käytetty usein jopa tiedostamatta Design Science -menetelmää \parencite{design_science_history}.
  ...
  Tutkimusidean hahmottelemisen ja ratkaisua kaipaavan ongelman identifioinnin jälkeen määritettiin tutkimuskysymykset valittua tutkimusmenetelmää käyttäen.
  Seuraavaksi kartoitettiin ratkaisuvaihtoehto tutkimuskysymyksiin ja vastaamaan työn yleiseen priorisoinnin teemaan liittyvään tutkimusongelmaan.
