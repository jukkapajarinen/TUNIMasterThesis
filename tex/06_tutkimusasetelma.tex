...
\section{Tutkimuksen rajaus} \label{ch:06_tutkimuksen_rajaus}
  ...
  Robot Framework soveltuu hyvin myös sellaisiin tilanteisiin, joissa halutaan ohjelmointikielillä määritettyjä testitapauksia korkeampaa abstraktiotasoa.
