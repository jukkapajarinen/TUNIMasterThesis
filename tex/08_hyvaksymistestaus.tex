...
\section{Hyväksymistestauksen tarkoitus} \label{08_hyvaksymistestauksen_tarkoitus}
...
\section{Hyväksymistestausvetoinen kehitys} \label{08_hyvaksymistestausvetoinen_kehitys}
...
\section{Robot Framework} \label{08_robot_framework}
...
\section{Testitapauksien määrittäminen} \label{08_testitapauksien_maarittaminen}
...
\section{Web-käyttöliittymien erityispiirteet} \label{08_webkayttoliittymien_erityispiirteet}
...
\end{itemize}
  ...
  \subsection{Selenium} \label{08_selenium}

  % Teksti tähän

  \subsection{Moni-selaimellinen testaus} \label{08_moniselaimellinen_testaus}

  % Teksti tähän

\section{Priorisointiongelma} \label{08_priorisointiongelma}
