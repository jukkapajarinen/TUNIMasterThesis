...
\section{Hyväksymistestausvetoinen kehitys} \label{ch:08_hyvaksymistestausvetoinen_kehitys}
  ...
  Hyväksymistestausvetoinen kehitys voidaan luokitella ketteräksi ohjelmistokehitysmenetelmäksi, kuten sen yläkäsitteenä oleva testausvetoinen kehityskin.
...
\section{Web-sovelluksien erityispiirteet} \label{ch:08_websovelluksien_erityispiirteet}
  ...
  Historiallisesti web-sivuilla navigointi tapahtuu niin sanottujen hyperlinkkien avulla, verkkosivujen itse ollessa hypertekstiä.
...
\section{Hyväksymistestausjärjestelmä} \label{ch:08_hyvaksymistestausjarjestelma}
  ...
  \subsection{Selenium} \label{ch:08_selenium}
    ...
    Selenium on ThoughtWorks yhtiön kehittämä verkkoselainten automatisoimiseen tarkoitettu työkalujen ja kirjastojen kokoelma ja se on saatavilla Windows, Linux ja MacOS alustoille \parencite{selenium_info_1}.
  ...
  \subsection{Xvfb} \label{ch:08_xvfb}
    ...
    Yhtenä Xvfb:n heikkoutena on, että se on saatavilla vain UNIX-pohjaisiin X-näyttöpalvelimen sisältäviin käyttöjärjestelmiin, kuten Linux ja MacOS.
