...
\section{Menetelmän evaluointi} \label{ch:12_menetelman_evaluointi}
  ...
  \begin{enumerate}
    \item <Näkymien ja siirtymien määrä esimerkissä ja arvio järkevästä näkymien määrästä priorisointia varten>
    \item<Testien määrät näkymää kohden, tähän joku lähde yleisistä määristä>
    \item<Resurssien säästö näkymissä (c = 80\%) ja näin ollen säästyneistä testitapauksista>
  \end{enumerate}
