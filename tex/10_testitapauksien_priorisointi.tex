...
\section{Verkon rakentaminen} \label{ch:10_verkon_rakentaminen}
  ...
  <TODO: Esimerkki näkymistä, joista verkon solmut ja kaaret poimitaan>
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/nakymat-ja-relaatiot.png}
    \caption{Painotettu verkko muodostetaan näkymistä ja relaatioista}
    \label{fig:nakymat-ja-relaatiot}
  \end{figure}
