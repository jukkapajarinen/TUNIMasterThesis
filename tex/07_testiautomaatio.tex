...
\section{Testitapaus ja testikokoelmat} \label{ch:07_testitapaus_ja_testikokoelmat}
  ...
  Alustuvaiheessa testitapauksen vaativa ympäristö ja muuttujat alustetaan.
  ...
  Tällaisessa ryhmittelyssä yksi kokoelma voi olla toiminnalliset testitapaukset ja toinen tehokkuutta mittaaville testitapauksille.
