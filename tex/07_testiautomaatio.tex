...
\section{Testauksen tasot} \label{ch:07_testauksen_tasot}
  ...
  \subsection{Yksikkötestaus} \label{ch:07_yksikkotestaus}
    ...
    Yksikkötestausta hyödynnetään usein myös ketterien menetelmien aihepiirissä, jossa ohjelmistotuotantoa voidaan toteuttaa muun muassa niin sanotulla testausvetoisella kehityksellä.
    Testausvetoisessa kehityksessä yksikkötestauksen osalta, ohjelmistokehittäjät laativat ensin yksikkötestit ennen yksiköiden toteuttamisen aloittamista.
...
\section{Testausvetoinen kehitys} \label{ch:07_testausvetoinen_kehitys}
  ...
  Testausvetoinen kehitys kuuluu ohjelmistotuotannossa vahvasti ketterien menetelmien alaisuuteen ja on kasvattanut suosiotaan ketterien menetelmien mukana \parencite{tdd_popularity}.
