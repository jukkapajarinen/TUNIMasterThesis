...
\section{Matemaattisten verkkojen tarkoitus} \label{ch:09_matemaattisten_verkkojen_tarkoitus}
  ...
  Alun perin verkkoteorian katsotaan syntyneen 1700-luvulla esiintyneestä, niin sanotusta Königsbergin siltaongelmasta, johon Leonhard Euler esitti todistuksensa \parencite{graph_theory_history}.
...
\section{Verkon rakentaminen} \label{ch:10_verkon_rakentaminen}
  ...
  Painotetun verkon kaaret voivat verkkoteorian mukaan olla suunnattuja tai suuntaamattomia \parencite{graph_theory_directed_non_directed}.
